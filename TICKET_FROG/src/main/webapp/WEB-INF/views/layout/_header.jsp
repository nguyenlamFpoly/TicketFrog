		...
		<div class="container-fluid">
			<div class="row align-items-center">
				...
				<div class="logo col-md-2 col-lg-2 d-none d-lg-block">
					<a href="/"> <img src="/assets/images/f.svg" alt="Belle Multipurpose Html Template" />
					</a>
				</div>
				<!--End Desktop Logo-->
				<div class="col-2 col-sm-3 col-md-3 col-lg-8">
					...
					<nav class="grid__item" id="AccessibleNav">
						...
						<ul id="siteNav" class="site-nav medium right hidearrow">
							...
							<li class="lvl1 parent megamenu"><a href="/product/list?kw="> Vé sự kiện
								 <i class="anm anm-angle-down-l"></i>
							</a>
								<div class="megamenu style4">
									<ul class="grid grid--uniform mmWrapper">
										<li class="grid__item lvl-1 col-md-3 col-lg-3"><a
											href="#" class="site-nav lvl-1">Vé sự kiện</a>
											<ul class="subLinks">
							...
							<li class="lvl1 parent megamenu"><a href="/brand/list"> Hot event
									 <i class="anm anm-angle-down-l"></i>
							</a>
								<div class="megamenu style2">
									<ul class="grid mmWrapper">
										<li class="grid__item one-whole">
											<ul class="grid">
												<li class="grid__item lvl-1 col-md-3 col-lg-3"><a
													href="#" class="site-nav lvl-1">Hot event</a>
													<ul class="subLinks">
	...
	<div class="mobile-nav-wrapper" role="navigation">
		...
		<ul id="MobileNav" class="mobile-nav">
			<li class="lvl1 parent megamenu"><a href="/home/index">trang
					chủ </a></li>
			<li class="lvl1 parent megamenu"><a href="#">Vé sự kiện <i
			...
			<li class="lvl1 parent megamenu"><a href="product-layout-1.html">Hot event
